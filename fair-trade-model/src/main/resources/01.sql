...
INSERT INTO fairtrade.User_Tbl (id, createDate, createUser, isActive, updateDate, updateUser, comments, email, firstName, gender, isExpired, lastName, password, role)
VALUES
